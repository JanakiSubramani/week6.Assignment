...
//	6. Enter Opportunity name as 'Salesforce Automation by Your Name,Get the text and Store it 
	driver.findElement(By.xpath("//label[text()='Opportunity Name']/following::input[1]")).sendKeys("Salesforce Automation by Janaki Subramani",Keys.ENTER);
	String oName = "Salesforce Automation by Janaki Subramani";
